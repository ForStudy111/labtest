<%-- 
    Document   : dashboard
    Created on : May 19, 2026, 4:18:05 PM
    Author     : wpy92
--%>
            ...
            <div class="card shadow-lg border-0 rounded-4 p-4 p-md-5 text-center" style="max-width: 600px; width: 100%;">
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-center gap-3 flex-wrap">
                        <a href="subject/viewSubjects.jsp" class="btn btn-primary px-4 py-2 fw-semibold">Manage Subjects</a>
                        ...
                        <a href="UserServlet?action=delete" 
                           ...
                           class="btn btn-danger px-4 py-2 fw-semibold">Delete Account
                        </a>
                    </div>
                </div>
            </div>
